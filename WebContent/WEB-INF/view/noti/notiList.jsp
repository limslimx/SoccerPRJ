			...
			<div class="content-body">
				...
				<div class="div_content_container"
					...
					<div style="display: table-row;">
						...
						<div class="table_3rd div_content_box">작성자</div>
						<div class="table_4th div_content_box">작성일</div>
						<div class="table_5th div_content_box">조회수</div>
					</div>
				</div>
				...
				<div class="div_content_container">
					...
					%>
					<div style="display: table-row;">
						<div class="table_1st div_content_box"><%=nDTO.getNotiNo()%></div>
						<div class="table_2nd div_content_box">
							<a href="/noti/notiDetail.do?seq=<%=nDTO.getNotiNo()%>"><%=nDTO.getTitle()%></a>
						</div>
						<div class="table_3rd div_content_box"><%=nDTO.getRegNo()%></div>
						<div class="table_4th div_content_box"><%=nDTO.getRegDate()%></div>
						<div class="table_5th div_content_box"><%=nDTO.getViewcount()%></div>
					</div>
					<%
						}
					%>
