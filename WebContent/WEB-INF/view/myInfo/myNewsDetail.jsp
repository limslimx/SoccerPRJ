...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	TeamNewsDTO nDTO = (TeamNewsDTO)request.getAttribute("nDTO");
%>
									...
									<div class="table-responsive">
										<form>
											...
											<div>
												...
												<div>
													<input type="button" onclick="location.href='/selectMyNews.do'" value="돌아가기" class="btn btn-primary" id="submitBtn" style="background-color:#48CFAD" />
												</div>
											</div>
										</form>
									</div>
